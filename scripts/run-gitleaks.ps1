...
$ToolDirectory = Join-Path $Root "tmp/security/gitleaks-$Version"
...
# Never trust a cached executable by self-reported version alone. Recreate it from the
# checksum-verified archive on every gate invocation.
