...
const result = spawnSync(
  ...
  [
    ...
    '--locked',
    '--features',
    'installed-acceptance-repair,acceptance-faults,machine-lock-test-namespace',
  ],
  {
    cwd: repositoryRoot,
    stdio: 'inherit',
...
await writeFile(
  ...
  `${JSON.stringify({ schemaVersion: 1, architecture, installedAcceptanceRepair: true, acceptanceFaults: true, promotable: false, setupSha256 })}\n`,
  'utf8',
);
