...
internal static class Observer
{
    ...
    static bool PipeExists(string name) { try { return Directory.GetFiles(@"\\.\pipe\").Any(path => String.Equals(Path.GetFileName(path), name, StringComparison.OrdinalIgnoreCase)); } catch { return false; } }
